...
describe('calculator functionality', function() {
  ...
  it('should be able show negative numbers', function() {
    running_total = element(by.css('#running_total'));
  ...
  it('should be able show decimal numbers as result', function() {
    running_total = element(by.css('#running_total'));
    element(by.css('#number1')).click();
  ...
  it('should be able show large numbers as result', function() {
    running_total = element(by.css('#running_total'));
  ...
  it('should show zero when dividing by zero', function() {
    running_total = element(by.css('#running_total'));
    element(by.css('#number1')).click();
    element(by.css('#operator_divide')).click();
